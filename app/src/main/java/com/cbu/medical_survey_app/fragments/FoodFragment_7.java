...
public class FoodFragment_7 extends Fragment {
    private Context nowContext;
    private Food7[] food7;
    ButtonListener bt1, bt2;
    Button food7_pre_bt, food7_next_bt;



    public FoodFragment_7(Context context) {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        ViewGroup vg = (ViewGroup) inflater.inflate(R.layout.food_frag_7, container, false);

        food7_pre_bt = vg.findViewById(R.id.bt_food7_prev);
        food7_next_bt = vg.findViewById(R.id.bt_food7_next);

        food7_pre_bt.setOnClickListener(bt1);
        food7_next_bt.setOnClickListener(bt2);
    ...
    private void initView(ViewGroup vg){
        ...
        for(int RowID=0;RowID<8;RowID++){
            ...
            for(int ColID=0;ColID<9;ColID++){
                rb1[ColID] = vg.findViewById(getResId(vg,"food7_fir_radio"+(RowID+1)+"_"+(ColID+1)));
            }
            for(int ColID=0;ColID<3;ColID++){
                rb2[ColID] = vg.findViewById(getResId(vg, "food7_sec_radio_avg" + (RowID + 1) + "_"+(ColID+1)));
            }

            food7[RowID] = new Food7(rb1,rb2);
        }
    ...
    private class Food7{
        ...
        public Food7(RadioButton[] rb1,RadioButton[] rb2){
            erb = rb1;
            yrb = rb2;
