...
public class StartPopupActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.start_alert_popup);


        TextView text = findViewById(R.id.start_text_popup);
        SpannableStringBuilder ssb = new SpannableStringBuilder(text.getText());
        ssb.setSpan(new ForegroundColorSpan(Color.parseColor("#FF0000")), 0, 16, Spannable.SPAN_EXCLUSIVE_EXCLUSIVE);
        text.setText(ssb);
